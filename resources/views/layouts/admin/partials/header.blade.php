<header x-data="{menuToggle: false}"
        ...
        <img src="{{ asset('images/PENMABAR.gif') }}" alt="Logo" class="w-16 h-auto" />
      </a>
  ...
  <a href="{{ route('admin.profile') }}"
    ...
    Edit profile
               ...
               <button class="group text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
